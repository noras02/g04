...
/*select title from movies_and_tv where country= 'United States' limit 10 ALLOW FILTERING;*/
...
```js
create index_i_foglalkozas on szemely(foglalkozas);
```
...
```js
select nev from szemely where foglalkozas = 'lakatos' OR foglalkozas = 'pincer';
